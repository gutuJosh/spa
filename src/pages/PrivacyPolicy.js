         ...
         <div className="wrapper">
          <div className="flex-grid">
           <div className="flex-lg-12 flex-md-12 flex-sm-12">
             <h2 className="text-white">{props.t('Policy sul trattamento dei dati dei utenti di Bancomail')}</h2>
       ...
       <section>
        <div className="wrapper">
         <div className="page-body flex-grid">
          <div className="flex-lg-12 flex-md-12 flex-sm-12"> 
            <h3>{props.t('Titolare del Trattamento dei Dati')}</h3>
            <p><strong>Neosoft S.r.l.</strong> (P.IVA: 01288440991 - REA: GE 398030), {props.t('con sede a Genova, via Casaregis 30/13 - 16129 - Genova')}</p>
            <p><strong>{props.t('Telefono')}:</strong> +39 010 8681372 / +39 010 8446402</p>
            ...
            <h3 className="mtop20">{props.t('Quali informazioni raccogliamo?')}</h3>
            ...
            <p>
                ...
                <br/>
                - {props.t('Per lo svolgimento delle attività di relazione con il cliente in base agli accordi contrattuali')}. 
                <br/>
                - {props.t('Per finalità amministrative e per l’adempimento di obblighi di legge quali ad esempio quelli di natura contabile, fiscale, o per dar corso a richieste dell’autorità giudiziaria.')}
                <br/>
                - {props.t('A fini statistici, per migliorare la nostra offerta e il servizio verso i clienti e per individuare e prevenire frodi e abusi.')}
                <br/>
                - {props.t('In presenza di specifico consenso, per l’invio periodico, tramite e-mail, di newsletter e materiale pubblicitario.')} 
                <br/>
                - {props.t('Nel caso di invio di curriculum vitae, esclusivamente per finalità di selezione.')}
            </p>
            <p>{props.t('Inoltre, utilizziamo le tue informazioni per creare il tuo account dove offriamo i nostri servizi e ti diamo visibilità dei dati in nostro possesso, unitamente alle modalità di esercizio dei tuoi diritti.')}</p>
            ...
            <h3 className="mtop20">{props.t('Come vengono conservati i dati e per quanto tempo?')}</h3>
            <p>{props.t('I dati raccolti sono trattati mediante strumenti informatici o comunque automatizzati, con logiche strettamente correlate alle finalità per le quali i dati personali sono stati raccolti e, comunque, in modo da garantire in ogni caso la sicurezza dei medesimi.')}</p>
            <p>{props.t('La gestione e la conservazione dei dati personali avviene su server ubicati all’interno ed all’esterno dell’Unione Europea di proprietà e/o nella disponibilità di Neosoft e/o di società terze incaricate, debitamente nominate quali responsabili del trattamento.')} {props.t('Il trasferimento all’estero dei dati nei paesi extra-UE avviene in conformità alle disposizioni contenute nel GDPR.')}</p>
            <p>{props.t('I dati sono conservati per il tempo necessario alla gestione delle finalità per le quali i dati stessi sono raccolti, nel rispetto delle norme vigenti e degli obblighi di legge.')}</p>
            
            <hr/>

            <h3 className="mtop20">{props.t('Quali sono i tuoi diritti sui dati?')}</h3>
            <p>{props.t('In ogni momento (se non ricorrono le limitazioni previste dalla legge) puoi richiedere accesso ai dati, opporti al trattamento o chiedere la cancellazione, la modifica o l’aggiornamento di tutte le informazioni raccolte da Neosoft, esercitando il diritto alla limitazione del trattamento e il diritto alla portabilità dei dati, inviando un’e-mail all’indirizzo')} 
