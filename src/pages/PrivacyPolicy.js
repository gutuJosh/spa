        ...
        <div className="wrapper">
         <div className="page-body flex-grid">
          <div className="flex-lg-12 flex-md-12 flex-sm-12"> 
            ...
            <p>{props.t('privacy:Il mancato conferimento dei dati comporterà l’impossibilità per Neosoft di dar corso agli impegni contrattuali assunti o alle richieste dell’utente.')}</p>
            <p>
            ...
            <p>
                {props.t('privacy:I dati forniti dall’utente sono raccolti e trattati per le seguenti finalità')}:
                <br/>
                - {props.t('privacy:Per lo svolgimento delle attività di relazione con il cliente in base agli accordi contrattuali')}. 
                <br/>
                - {props.t('privacy:Per finalità amministrative e per l’adempimento di obblighi di legge quali ad esempio quelli di natura contabile, fiscale, o per dar corso a richieste dell’autorità giudiziaria.')}
                <br/>
                ...
                <br/>
                - {props.t('privacy:Nel caso di invio di curriculum vitae, esclusivamente per finalità di selezione.')}
            </p>
            <p>{props.t('privacy:Inoltre, utilizziamo le tue informazioni per creare il tuo account dove offriamo i nostri servizi e ti diamo visibilità dei dati in nostro possesso, unitamente alle modalità di esercizio dei tuoi diritti.')}</p>
            ...
            <p>{props.t('privacy:Il trattamento dei dati raccolti è effettuato da personale interno di Neosoft autorizzato al trattamento secondo specifiche istruzioni impartite nel rispetto della normativa vigente.')}</p>
            <p>{props.t('privacy:I tuoi dati non saranno mai ceduti a terzi, né inseriti nel Database Bancomail, a meno che non siano stati conferiti spontaneamente su questo sito nell’apposita form Fanne Parte (sezione Supporto) o acquisite attraverso altre fonti autorizzate, in ogni caso previa comunicazione.')}</p>
            <p>
              {props.t('privacy:Tuttavia, è possibile che alcuni tuoi dati vengano condivisi da noi con fornitori fidati, necessari per offrire servizio per nostro conto come comunicazione tramite email e annunci pubblicitari basati sugli interessi.')}&nbsp;
              {props.t('privacy:Condividiamo solo le informazioni minime necessarie e non è consentito a soggetti terzi di utilizzare le tue informazioni per scopi diversi da quelli indicati nella nostra Policy sulla privacy.')}
            ...
            <p>{props.t('privacy:I dati raccolti sono trattati mediante strumenti informatici o comunque automatizzati, con logiche strettamente correlate alle finalità per le quali i dati personali sono stati raccolti e, comunque, in modo da garantire in ogni caso la sicurezza dei medesimi.')}</p>
            <p>{props.t('privacy:La gestione e la conservazione dei dati personali avviene su server ubicati all’interno ed all’esterno dell’Unione Europea di proprietà e/o nella disponibilità di Neosoft e/o di società terze incaricate, debitamente nominate quali responsabili del trattamento.')} {props.t('privacy:Il trasferimento all’estero dei dati nei paesi extra-UE avviene in conformità alle disposizioni contenute nel GDPR.')}</p>
            <p>{props.t('privacy:I dati sono conservati per il tempo necessario alla gestione delle finalità per le quali i dati stessi sono raccolti, nel rispetto delle norme vigenti e degli obblighi di legge.')}</p>
